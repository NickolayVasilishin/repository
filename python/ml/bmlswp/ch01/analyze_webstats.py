...
# polyfit вписывает полином в точки и возвращает коэффициенты
...
# poly1d возвращает объект-полином с этими коэффициентами. Можно, например, находить значения с помощью f1(5)
# Выше в plot_models сначала рисуем точки, затем рисуем найденные полиномы
# for model, style, color in zip(models, linestyles, colors):
#    plt.plot(шаг, модель(mx), linestyle=style, linewidth=2, c=color)
f1 = sp.poly1d(fp1)
