...
package com.epam.hadoop.nv.yarn;
...
import com.epam.hadoop.nv.YarnUI;
...
public class Client {
	 ...
	 */
	public static void main(YarnUI ui, String[] args) {
		boolean result = false;
		try {
			Client client = new Client();
			LOG.info("Initializing Client");
    		Logger.getLogger(Client.class.getName()).info("Initializing Client");
			try {
    		...
    		Logger.getLogger(Client.class.getName()).info("Running client");
			result = client.run();
		} catch (Throwable t) {
    		Logger.getLogger(Client.class.getName()).info("Error running client");
			LOG.fatal("Error running CLient", t);
			ui.notifyError();
			// System.exit(1);
		}
		if (result) {
    		Logger.getLogger(Client.class.getName()).info("Completed");
			LOG.info("Application completed successfully");
			ui.notifyCompleted();
			// System.exit(0);
		}
		Logger.getLogger(Client.class.getName()).info("Failed");
